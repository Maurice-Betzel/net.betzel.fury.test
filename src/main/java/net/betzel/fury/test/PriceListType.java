...
@XmlType(name = "PriceListType", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2", propOrder = {
    "ublExtensions",
    "id",
    "statusCode",
    "validityPeriods",
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "PreviousPriceList", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")
    @Valid
