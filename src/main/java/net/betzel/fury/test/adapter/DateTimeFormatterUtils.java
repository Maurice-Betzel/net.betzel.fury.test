...
public class DateTimeFormatterUtils {
     ...
     *
     * <p>
     * {@link #fromTemporalAccessorToOffsetDateTimeNoTime(TemporalAccessor, Function, int, int)
     ...
     */
    public static OffsetUtcDate fromTemporalAccessorToOffsetDate(TemporalAccessor temporal, Function<LocalDate, ZoneOffset> zoneOffsetProvider, int defaultMonth, int defaultDayOfMonth) {
        LocalDate date = getLocalDate(temporal, defaultMonth, defaultDayOfMonth);
        ZoneOffset offset = temporal.query(TemporalQueries.offset());
     ...
     *
     * <p>
     * This method is an alternative to {@link #fromTemporalAccessorToOffsetDate(TemporalAccessor, Function, int, int)
     * fromTemporalAccessorToOffsetDate()} method when use of the proprietary
     * {@link OffsetUtcDate OffsetDate} is unacceptable or not
     * needed.
     *
     * @param temporal           the input
     * @param zoneOffsetProvider a function which will be called if no zone offset
     ...
     * {@link #fixTooManySecondsDecs(String, DateTimeParseException)  fixed}
