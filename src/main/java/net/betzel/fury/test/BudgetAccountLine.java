...
@XmlType(name = "BudgetAccountLineType", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2", propOrder = {
    "ublExtensions",
    "id",
    "totalAmount",
    "budgetAccounts"
})
@XmlRootElement(name = "BudgetAccountLine", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "BudgetAccount", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")
    @Valid
    protected List<BudgetAccount> budgetAccounts;
     ...
     * This is why there is not a <CODE>set</CODE> method for the budgetAccounts property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getBudgetAccounts().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<BudgetAccount> getBudgetAccounts() {
        if (budgetAccounts == null) {
            budgetAccounts = new ArrayList<BudgetAccount>();
        }
