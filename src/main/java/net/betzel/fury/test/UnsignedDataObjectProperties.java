...
@XmlType(name = "UnsignedDataObjectPropertiesType", namespace = "http://uri.etsi.org/01903/v1.3.2#", propOrder = {
    "unsignedDataObjectProperties"
})
@XmlRootElement(name = "UnsignedDataObjectProperties", namespace = "http://uri.etsi.org/01903/v1.3.2#")
    ...
    implements Serializable
{
    ...
    @Size(min = 1)
    @Valid
    protected List<AnyType> unsignedDataObjectProperties;
     ...
     * This is why there is not a <CODE>set</CODE> method for the unsignedDataObjectProperties property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getUnsignedDataObjectProperties().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<AnyType> getUnsignedDataObjectProperties() {
        if (unsignedDataObjectProperties == null) {
            unsignedDataObjectProperties = new ArrayList<AnyType>();
        }
