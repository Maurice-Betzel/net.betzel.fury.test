...
@XmlType(name = "CertificateType", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2", propOrder = {
    "ublExtensions",
    "id",
    "certificateTypeCode",
    "certificateTypes",
    ...
    implements Serializable
{
    ...
    @Valid
    protected List<CertificateType2> certificateTypes;
    ...
    /**
     * Gets the value of the certificateTypes property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the certificateTypes property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCertificateTypes().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<CertificateType2> getCertificateTypes() {
        if (certificateTypes == null) {
            certificateTypes = new ArrayList<CertificateType2>();
        }
