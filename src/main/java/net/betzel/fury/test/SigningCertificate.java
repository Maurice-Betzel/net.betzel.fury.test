...
@XmlType(name = "CertIDListType", namespace = "http://uri.etsi.org/01903/v1.3.2#", propOrder = {
    "certs"
})
@XmlRootElement(name = "SigningCertificate", namespace = "http://uri.etsi.org/01903/v1.3.2#")
