...
@XmlType(name = "CreditNoteLineType", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2", propOrder = {
    "ublExtensions",
    "id",
    "uuid",
    "notes",
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "SubCreditNoteLine", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")
    @Valid
    ...
    /**
     * Gets the value of the creditedQuantity property.
     * 
     * @return
     *     possible object is
