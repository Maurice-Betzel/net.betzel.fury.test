...
@XmlType(name = "DigitalProcessType", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2", propOrder = {
    "ublExtensions",
    "id",
    "descriptions",
    "profileID",
...
@XmlRootElement(name = "DigitalProcess", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "DigitalCollaboration", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")
    @Valid
    protected List<DigitalCollaboration> digitalCollaborations;
    ...
    /**
     * Gets the value of the digitalCollaborations property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the digitalCollaborations property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDigitalCollaborations().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link DigitalCollaboration }
     * 
     * 
     */
    public List<DigitalCollaboration> getDigitalCollaborations() {
        if (digitalCollaborations == null) {
            digitalCollaborations = new ArrayList<DigitalCollaboration>();
        }
