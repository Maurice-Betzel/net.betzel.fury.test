...
@XmlType(name = "GoodsItemContainerType", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2", propOrder = {
    "ublExtensions",
    "id",
    "quantity",
    "transportEquipments"
})
@XmlRootElement(name = "GoodsItemContainer", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")
