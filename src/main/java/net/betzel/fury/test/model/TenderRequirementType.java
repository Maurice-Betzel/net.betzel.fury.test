...
@XmlType(name = "TenderRequirementType", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2", propOrder = {
    "ublExtensions",
    "names",
    "descriptions",
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "TemplateDocumentReference", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")
    @Valid
