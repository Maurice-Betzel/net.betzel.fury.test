...
@XmlType(name = "ReferenceInfoType", namespace = "http://uri.etsi.org/01903/v1.3.2#", propOrder = {
    "digestMethod",
    "digestValue"
})
@XmlRootElement(name = "ReferenceInfo", namespace = "http://uri.etsi.org/01903/v1.3.2#")
