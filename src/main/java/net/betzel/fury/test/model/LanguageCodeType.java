...
@XmlType(name = "LanguageCodeType", namespace = "urn:oasis:names:specification:ubl:schema:xsd:QualifiedDataTypes-2")
@XmlSeeAlso({
    TenderLanguageLocaleCode.class,
    PreferredLanguageLocaleCode.class,
    LocaleCode.class
})
