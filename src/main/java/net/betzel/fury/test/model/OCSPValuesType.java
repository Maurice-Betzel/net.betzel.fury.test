    ...
    implements Serializable
{
    ...
    @Size(min = 1)
    @Valid
    protected List<EncapsulatedPKIDataType> encapsulatedOCSPValues;
     ...
     * This is why there is not a <CODE>set</CODE> method for the encapsulatedOCSPValues property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEncapsulatedOCSPValues().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<EncapsulatedPKIDataType> getEncapsulatedOCSPValues() {
        if (encapsulatedOCSPValues == null) {
            encapsulatedOCSPValues = new ArrayList<EncapsulatedPKIDataType>();
        }
