 ...
 * 
 * <pre>
 * &lt;?xml version="1.0" encoding="UTF-8"?&gt;&lt;ccts:UniqueID xmlns:ccts="urn:un:unece:uncefact:documentation:2" xmlns:ccts-cct="urn:un:unece:uncefact:data:specification:CoreComponentTypeSchemaModule:2" xmlns:xsd="http://www.w3.org/2001/XMLSchema"&gt;BDNDRUDT000002&lt;/ccts:UniqueID&gt;
 * </pre>
 * 
 * <pre>
...
@XmlType(name = "BinaryObjectType", namespace = "urn:oasis:names:specification:bdndr:schema:xsd:UnqualifiedDataTypes-1")
@XmlSeeAlso({
    EmbeddedDocumentBinaryObject.class,
    ResponseBinaryObject.class
})
public class BinaryObjectType
    extends BinaryObjectType2
