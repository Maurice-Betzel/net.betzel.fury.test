    ...
    implements Serializable
{
     ...
     * @return
     *     possible object is
     *     {@link SignatureMethod2 }
     *     
     */
    public SignatureMethod2 getSignatureMethod() {
     ...
     *     
     */
    public void setSignatureMethod(SignatureMethod2 value) {
     ...
     * 
     */
    public List<Reference2> getReferences() {
        if (references == null) {
            references = new ArrayList<Reference2>();
        }
