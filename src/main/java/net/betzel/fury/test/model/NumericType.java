...
@XmlType(name = "NumericType", namespace = "urn:oasis:names:specification:bdndr:schema:xsd:UnqualifiedDataTypes-1")
@XmlSeeAlso({
    WeightNumeric.class,
    ReminderSequenceNumeric.class,
    MultiplierFactorNumeric.class,
    MaximumOriginalsNumeric.class,
    MaximumCopiesNumeric.class,
    MinimumValueNumeric.class,
    MaximumValueNumeric.class,
    ExpectedValueNumeric.class,
    CalculationSequenceNumeric.class,
    ResponseNumeric.class,
    MaximumLotsSubmittedNumeric.class,
    MaximumLotsAwardedNumeric.class,
