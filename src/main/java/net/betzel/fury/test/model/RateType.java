...
@XmlType(name = "RateType", namespace = "urn:oasis:names:specification:bdndr:schema:xsd:UnqualifiedDataTypes-1")
@XmlSeeAlso({
    TargetCurrencyBaseRate.class,
    SourceCurrencyBaseRate.class,
    Rate.class,
    OrderableUnitFactorRate.class,
    CalculationRate.class,
    AmountRate.class
})
