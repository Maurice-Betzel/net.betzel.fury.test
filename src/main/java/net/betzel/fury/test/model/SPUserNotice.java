...
@XmlType(name = "SPUserNoticeType", namespace = "http://uri.etsi.org/01903/v1.3.2#", propOrder = {
    "noticeRef",
    "explicitText"
})
@XmlRootElement(name = "SPUserNotice", namespace = "http://uri.etsi.org/01903/v1.3.2#")
