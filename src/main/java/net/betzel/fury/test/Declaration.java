...
@XmlType(name = "DeclarationType", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2", propOrder = {
    "ublExtensions",
    "names",
    "declarationTypeCode",
    "descriptions",
...
@XmlRootElement(name = "Declaration", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")
    ...
    implements Serializable
{
    ...
    @Valid
    protected DeclarationTypeCode declarationTypeCode;
     ...
     * @return
     *     possible object is
     *     {@link DeclarationTypeCode }
     *     
     */
    public DeclarationTypeCode getDeclarationTypeCode() {
     ...
     *     
     */
    public void setDeclarationTypeCode(DeclarationTypeCode value) {
