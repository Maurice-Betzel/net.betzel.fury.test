    ...
    implements Serializable
{
    ...
    @Valid
    protected List<LineResponse> lineResponses;
    ...
    /**
     * Gets the value of the lineResponses property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the lineResponses property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getLineResponses().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<LineResponse> getLineResponses() {
        if (lineResponses == null) {
            lineResponses = new ArrayList<LineResponse>();
        }
