...
@XmlType(name = "EncryptionCertificatePathChainType", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2", propOrder = {
    "ublExtensions",
    "value",
    "uri"
})
@XmlRootElement(name = "EncryptionCertificatePathChain", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")
public class EncryptionCertificatePathChain
